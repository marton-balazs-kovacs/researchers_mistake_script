...
```{r}
ggsave("Figures/frequent_cause_type_relationship_plot.png", width = 14.4, height = 8, plot = last_plot())
```
...
```{r}
ggsave("Figures/serious_cause_type_relationship_plot.png", width = 14.4, height = 8, plot = last_plot())
```
...
```{r}
ggsave("Figures/frequent_outcome_type_relationship_plot.png", width = 14.4, height = 8, plot = last_plot())
```
...
```{r}
ggsave("Figures/serious_outcome_type_relationship_plot.png", width = 14.4, height = 8, plot = last_plot())
```
