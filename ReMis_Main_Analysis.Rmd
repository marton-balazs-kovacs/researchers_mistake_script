...
```{r}
ggsave("Figures/years_on_field_plot.png", plot = last_plot(), dpi = 300, width = 50, height = 30, units = "cm")
```
...
```{r}
ggsave("Figures/subfield_distribution_plot.png", plot = last_plot(), dpi = 300, width = 50, height = 30, units = "cm")
```
...
```{r}
ggsave("Figures/overview_mistakes_plot_count.png", width = 14.4, height = 9, plot = last_plot())
```
