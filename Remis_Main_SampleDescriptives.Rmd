...
There were `batch_3_history %>% count()` emails sent out to this sample.
...
There were `batch_5_history %>% count()` emails sent out to this sample.
...
There were `batch_6_history %>% count()` emails sent out to this sample.
