...
We flagged the mistakes that needed to be excluded from the analysis of the frequency and seriousness ratings during the preprocessing of the free-text responses in order to save time. Therefore, we use the coded mistake dataset to excluded cases that fit our exclusion criteria.
